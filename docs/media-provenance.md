...
> **Replaced:** the previous `audio/sfx/handset/*` and ring/glitch clips were
> sourced from public sample banks and have been **removed and regenerated** with
> Stable Audio Open. The originals are kept locally under `audio/sfx/_replaced/`
> (excluded from the repo and the bundle) and must not be redistributed.
